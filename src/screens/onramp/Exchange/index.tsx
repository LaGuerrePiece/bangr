...
const ReceiveScreen = () => {
  ...
  return (
    <View className="h-full items-center bg-primary-light p-5 py-6 dark:bg-primary-dark">
      ...
      {smartWalletAddress && (
        <View className="mx-auto my-3 items-center rounded-xl bg-primary-light  dark:bg-primary-dark">
          <QRCode
          ...
          <View className="my-4 flex-row">
            <View className="rounded-xl border border-typo-light bg-primary-light p-2 dark:border-typo-dark dark:bg-primary-dark">
              <TouchableOpacity
                onPress={() => {
